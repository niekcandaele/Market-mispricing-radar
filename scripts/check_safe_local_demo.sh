...
EVIDENCE_DIR="${MMR_SAFE_LOCAL_EVIDENCE_DIR:-/home/catalysm/.openclaw/workspace/state/hackathons/market-mispricing-radar}"
ARCHIVE_ROOT="${MMR_SAFE_LOCAL_ARCHIVE_ROOT:-/home/catalysm/.openclaw/workspace/state/archive}"
ARCHIVE_DAY="$(date +%F)"
