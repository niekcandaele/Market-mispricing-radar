...
repo = Path('/home/catalysm/code/market-mispricing-radar')
skill = Path('/home/catalysm/.openclaw/workspace/skills/slides-generator')
out = repo / 'artifacts' / 'submission' / 'slides-generator-deck'
img_dir = out / 'images'
out.mkdir(parents=True, exist_ok=True)
img_dir.mkdir(parents=True, exist_ok=True)

# Generated by slides-generator image plan, 2026-04-25.
generated = {
    'hero': Path('/home/catalysm/.openclaw/media/tool-image-generation/mmr_deck_hero---8464f5f6-3195-4661-a869-3ae1e2fa38df.png'),
    'inspection': Path('/home/catalysm/.openclaw/media/tool-image-generation/mmr_deck_inspection---63738efc-1af2-4b92-b708-115332c16999.png'),
    'pipeline': Path('/home/catalysm/.openclaw/media/tool-image-generation/mmr_deck_pipeline---94d7b650-f2a9-4784-ac24-3d76b8f1c267.png'),
}
for key, src in generated.items():
    shutil.copy2(src, img_dir / f'{key}.png')
...
base_css = (skill / 'assets/viewport-base.css').read_text()
