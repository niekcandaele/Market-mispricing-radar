...
- no verified public Zerve project/share URL yet. Authenticated canvas metadata evidence still says `canvas.is_public: false`, and the latest public-share gate is still red.
