...
- A follow-up live notebook pass on 2026-04-21 upgraded `fetch_polymarket_data` to the hardened ingestion code and then added working `normalize_markets`, `build_market_features`, and `score_markets` blocks.
