...
The live Devpost page was rechecked again on 2026-04-28 and says to tag:
- `@Zerve AI` on LinkedIn
- `@Zerve_AI` on X

Evidence: `/home/catalysm/.openclaw/workspace/state/hackathons/market-mispricing-radar/devpost-requirements-check-20260428T1732Z.json`. Still check the exact platform autocomplete before posting in case branding display differs.
